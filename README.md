...
So, you must copy the k8s (containing manifest_k8s.yaml) and python-docker (containing the files: app.py, requirements.txt and Dockerfile) directories to the local machine.
